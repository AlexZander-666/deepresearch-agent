...
class Configuration:
    ...
    SANDBOX_TEMPLATE_CODE: Optional[str] = os.getenv('SANDBOX_TEMPLATE_CODE', 'br263f8awvhrqd7ss1ze')  # code-interpreter-v1
    SANDBOX_TEMPLATE_DESKTOP: Optional[str] = os.getenv('SANDBOX_TEMPLATE_DESKTOP', '4imxoe43snzcxj95hvha') # desktop (VNC)
    SANDBOX_TEMPLATE_BROWSER: Optional[str] = os.getenv('SANDBOX_TEMPLATE_BROWSER', '7xvs3snis3tkuq3y8u96') # browser-chromium
    SANDBOX_TEMPLATE_BASE: Optional[str] = os.getenv('SANDBOX_TEMPLATE_BASE', 'txi15v1zt0q72i1gcyqb') # base
