...
CREATE OR REPLACE FUNCTION is_AlexManus_default_agent(agent_row agents)
RETURNS boolean
LANGUAGE plpgsql
IMMUTABLE
AS $$
...
GRANT EXECUTE ON FUNCTION is_AlexManus_default_agent(agents) TO authenticated, service_role;
