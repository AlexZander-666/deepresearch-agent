...
export function WebSearchToolView({
  ...
  // 🐛 Debug logging for WebSearch data
  console.log('🔍 [WebSearchToolView] Debug data:', {
    name,
    isStreaming,
    isSuccess,
    query,
    ...
    assistantContentPreview: typeof assistantContent === 'string' ? assistantContent.slice(0, 200) : JSON.stringify(assistantContent).slice(0, 200),
    toolContentPreview: typeof toolContent === 'string' ? toolContent.slice(0, 200) : JSON.stringify(toolContent).slice(0, 200)
  });
